...
class Sudoku::Cell
    ...
    def initialize(puzzle:, value:, ci:, cj:, options: fresh_options)
        ...
        @cell_cache = Sudoku::SudokuCache.new({
    ...
    def forbid_multiple(options_to_forbid, display_speed: nil, print_progress: nil)
    ...
    def forbid(option_to_forbid, display_speed: nil, print_progress: nil)
    ...
    def forbid_siblings(display_speed: nil, print_progress: nil)
        siblings.each { |sibling| sibling.forbid(self.value, display_speed: display_speed, print_progress: print_progress) }
    end
    ...
    def confirm(value)
        ...
        self.forbid_siblings(display_speed: @display_speed, print_progress: @print_progress)
        true
    end
